...
// The correct Supabase connection string
...
// Set the DATABASE_URL environment variable programmatically
process.env.DATABASE_URL = SUPABASE_DB_URL;

// Also update the .env file to make the change persistent
try {
...
console.log(`Using Supabase connection: ${SUPABASE_DB_URL.replace(/:[^:]*@/, ':****@')}`);
